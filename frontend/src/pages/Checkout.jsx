  ...
  return (
    <section className="bg-gray-50 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <h1 className="text-4xl sm:text-5xl font-black mb-10 sm:mb-14 leading-tight">
          Checkout
        </h1>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <form
            ...
            className="lg:col-span-2 bg-white rounded-3xl shadow-lg p-6 sm:p-8 lg:p-10"
          >
            <h2 className="text-3xl font-black mb-10">Delivery Information</h2>
            ...
            <div className="mt-10 bg-blue-50 rounded-2xl p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold">Secure M-Pesa Payment</h3>

                  <p className="text-gray-600 mt-1">
                    After placing your order you'll receive an M-Pesa STK Push
                    on your phone.
                  </p>
                </div>
              </div>
