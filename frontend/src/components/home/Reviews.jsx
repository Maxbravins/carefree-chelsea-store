    ...
    <section className="py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <span className="inline-block bg-blue-100 text-[#034694] px-4 sm:px-5 py-2 rounded-full font-bold uppercase tracking-[0.2em] sm:tracking-[0.35em] text-xs sm:text-sm">
            Testimonials
          </span>

          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black mt-8 leading-tight">
            Loved By Chelsea Fans
          </h2>

          <p className="text-gray-600 text-base sm:text-lg leading-7 sm:leading-8 mt-6">
            Thousands of Chelsea supporters trust Carefree Chelsea Store for
            premium quality merchandise, secure payments and exceptional
            customer service.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-10 mt-20">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="group relative bg-gray-50 rounded-3xl p-6 sm:p-8 md:p-10 hover:bg-white hover:shadow-2xl hover:-translate-y-3 transition-all duration-300"
            >
              <Quote
                size={55}
              ...
              <div className="flex items-center gap-5 mb-8">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <BadgeCheck size={20} className="text-[#034694]" />
                  </div>
