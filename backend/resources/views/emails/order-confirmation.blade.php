...
.payment-box { background: #f0fdf4; border-radius: 12px; padding: 16px; margin-top: 24px; border: 1px solid #bbf7d0; font-size: 14px; line-height: 1.6; }
.paid-status { color: #15803d; font-weight: 800; }
.pending-status { color: #d97706; font-weight: 800; }
    ...
    <div class="wrapper">
        ...
        <div class="body-content">
            ...
            <p style="color: #475569; line-height: 1.6;">
                ...
                Below is a detailed breakdown of your order:
            </p>
                ...
                <tbody>
                    @foreach ($order->items as $item)
                        <tr>
                            <td>
                                <strong>
                                    {{ $item->product->name ?? 'Chelsea Product' }}
                                </strong>
            ...
            <div class="payment-box">
                ...
                <span class="{{ $order->payment?->status === 'paid' ? 'paid-status' : 'pending-status' }}">
                    {{ $order->payment?->status === 'paid' ? '✓ PAID' : strtoupper($order->payment?->status ?? 'PENDING') }}
                </span>
                <br>
                ...
                {{ $order->payment?->mpesa_receipt ?? 'N/A' }}
            ...
            <p style="
                ...
                line-height: 1.5;
            ">
                If you have any questions or need to make changes to your delivery address,
                please reply directly to this email or contact our support line.
            </p>
        ...
        <!-- Footer -->
        <div class="footer">
            &copy; {{ date('Y') }} Carefree Chelsea Store —
            Pride of London in Kenya.
        </div>
